                    ...
                    <form action="{{ route('categories.add') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <input type="color" class="d-none" id="tag_color" name="tag_color" value="#ff0000">
                                <div class="color-preview" style="width: 30px; height: 30px; background-color: #ff0000; border-radius: 50%; transition: all 0.3s ease; cursor: pointer; box-shadow: 0 2px 8px rgba(0,0,0,0.3);" title="Нажмите для выбора цвета"></div>
                            </div>
                        </div>
